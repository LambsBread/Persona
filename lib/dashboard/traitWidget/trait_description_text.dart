...
class TraitDescriptionText extends StatelessWidget {
  const TraitDescriptionText({Key? key, required List<double> this.scores})
      : super(key: key);
            ...
            children: [
              ...
              Text("-Avoid change",
                  style: GoogleFonts.roboto(
                      fontSize: 18, fontWeight: FontWeight.w400)),
              SizedBox(height: 5),
              Text("-Are more traditional in your thinking",
                  style: GoogleFonts.roboto(
                      fontSize: 18, fontWeight: FontWeight.w400)),
              SizedBox(height: 15),
              Text(
              ...
              SizedBox(height: 10),
              Text("If you scored high on conscientiousness, you might:",
                  style: GoogleFonts.roboto(
                      fontSize: 19, fontWeight: FontWeight.w400)),
              SizedBox(height: 10),
              ...
              Text(
                  ...
                  overflow: TextOverflow.visible),
              SizedBox(height: 15),
              Text("A low score on conscientiousness might mean you:",
                  style: GoogleFonts.roboto(
                      fontSize: 19, fontWeight: FontWeight.w400)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 10),
              Text("A high score in agreeableness might mean you:",
                  style: GoogleFonts.roboto(
                      fontSize: 19, fontWeight: FontWeight.w400)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 15),
              Text(
                  "If you scored high in agreeableness, you you’re"
              ...
              SizedBox(height: 15),
              Text(
                  "If you scored high on neuroticism, you may blame "
